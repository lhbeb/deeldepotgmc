...
const NewsletterSection = () => {
  ...
  return (
    <section className="bg-[#030B19] py-16 px-4">
          ...
          <form onSubmit={handleSubmit} className="max-w-md mx-auto">
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              <button
                type="submit"
                disabled={isSubmitting || isSuccess}
                className="bg-[#f5970c] text-[#030B19] hover:bg-[#f5970c]/90 disabled:opacity-50 disabled:cursor-not-allowed px-6 py-3 rounded-lg font-bold transition-all duration-200 flex items-center justify-center gap-2 min-w-[140px] shadow-lg shadow-[#f5970c]/20"
              >
                {isSubmitting ? (
                  <>
