        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
          {products.map((product) => (
            ...
            >
              ...
              <div className="p-4 space-y-3">
                <h3 className="font-semibold text-[#262626] group-hover:text-[#030B19] transition-colors line-clamp-2 sm:line-clamp-1">
                  {product.title}
                </h3>
                ...
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 mt-2">
                  <div className="flex items-center text-sm font-medium text-[#030B19]">
                    <Eye className="h-4 w-4 mr-1" />
                    <span>View Details</span>
                  </div>
                  <div className="h-8 w-8 bg-[#030B19] rounded-full flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
