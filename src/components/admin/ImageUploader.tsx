        ...
        <div>
            ...
            className={`
              ...
              ${
                dragActiveThumbnail
                  ...
                  : 'border-[#030B19]/30 hover:border-[#030B19]/50'
              }
          ...
          >
            ...
            {uploading && pendingThumbnail ? (
              ...
              <div className="space-y-2">
                <Upload className="h-10 w-10 mx-auto text-[#030B19]" />
                <div>
          ...
          {(thumbnail || pendingThumbnail) && (
            <div className="mt-4">
              <div className="inline-block relative group">
                <div className="relative w-32 h-32 rounded-lg overflow-hidden border-2 border-[#030B19] bg-gray-100">
                  {pendingThumbnail ? (
                    <Image
                  ...
                  {pendingThumbnail && (
                    <div className="absolute top-1 right-1 bg-[#030B19] text-white text-xs px-2 py-0.5 rounded">
                      Pending
                    </div>
                  )}
                  <div className="absolute bottom-1 left-1 bg-[#030B19] text-white text-xs px-2 py-0.5 rounded font-semibold">
                    Thumbnail
                  </div>
                </div>
              </div>
