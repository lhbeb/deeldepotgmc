    ...
    <div className={`w-full ${fullWidth ? '' : 'max-w-7xl'} mx-auto`}>
      ...
      <div className="rounded-2xl overflow-hidden shadow-sm mb-8">
        <div className="flex flex-col md:flex-row">
          ...
          <div className="md:w-[45%] relative">
            <div className="relative w-full min-h-[400px]">
              <Image
                ...
                alt="Deel Depot delivery person"
                fill
          ...
          <div className="md:w-[55%] bg-[#030B19] text-[#F0F6FF] p-12 flex flex-col justify-center">
            <h1 className="text-4xl md:text-5xl font-bold leading-tight mb-6 text-[#f5970c]">
              Same Day Shipping
            </h1>

            <p className="text-lg leading-relaxed font-normal mb-12">
              Order by 2:00 PM EST and we&apos;ll process, pack, and ship your order the same day. At <strong>Deel Depot</strong>, we deliver speed and reliability you can count on with trusted delivery partners.
            </p>
            <Link
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        ...
        <div className="bg-white rounded-xl p-6 shadow-sm">
          <div className="flex items-start gap-4">
            <div className="bg-[#030B19] rounded-full p-3 flex-shrink-0">
      ...
      <div className="bg-white rounded-xl p-8 shadow-sm flex flex-col md:flex-row items-center justify-between gap-6">
        <div>
          ...
          <p className="text-2xl md:text-3xl font-bold text-[#262626]">
            Order by <span className="text-[#030B19]">2:00 PM EST</span> for same-day shipping
          </p>
        </div>
        <a
          href="#products"
          className="bg-[#030B19] hover:bg-[#0a0f32] text-[#F0F6FF] font-bold py-4 px-10 rounded-xl text-lg transition-colors whitespace-nowrap"
        >
          Shop Now
        </a>
      </div>
