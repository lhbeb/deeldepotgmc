        ...
        <div className="mx-auto max-w-7xl">
          <div className="mb-8 md:mb-10">
            <h2
              ...
              className="text-3xl font-bold tracking-tight text-[#030B19] md:text-4xl"
            >
              Popular Categories
            </h2>
          </div>
          ...
          <div className="grid grid-cols-2 gap-3 sm:gap-4 lg:grid-cols-5">
            {categories.map((category) => (
              <Link
                ...
                className="relative overflow-hidden rounded-2xl border border-[#030B19]/10 bg-white shadow-[0_12px_30px_rgba(3,11,25,0.06)] transition-colors duration-200 hover:border-[#030B19]/25"
              ...
              >
                ...
                <div className="flex min-h-20 items-center bg-[#030B19] px-4 py-4 text-[#F0F6FF] sm:px-5">
