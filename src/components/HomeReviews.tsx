          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100">
            <div className="p-8 text-center">
              ...
              <button
                ...
                className="bg-[#030B19] hover:bg-[#0a0f32] text-[#F0F6FF] px-6 py-3 rounded-lg font-medium transition-colors duration-200"
              >
                Write a Review
              </button>
            </div>
            ...
            <div className="border-b border-gray-200 p-6">
              <div className="flex flex-col md:flex-row md:items-start justify-between gap-6">
                    ...
                    <div>
                      <div className="flex">
                        {[...Array(5)].map((_, i) => (
                          <Star 
                            key={i}
                            className={`h-5 w-5 ${i < Math.floor(reviewStats.averageRating) ? 'text-[#030B19] fill-[#030B19]' : 'text-gray-300'}`}
                          />
                        ))}
                      </div>
                ...
                <div className="flex items-center">
                  <button
                    onClick={() => setShowReviewForm(true)}
                    className="bg-[#030B19] hover:bg-[#0a0f32] text-[#F0F6FF] px-6 py-3 rounded-lg font-medium transition-colors duration-200 flex items-center gap-2"
                  >
              ...
              {displayReviews.map((review, index) => {
                ...
                return (
                      ...
                      <div className="flex items-start justify-between gap-2 mb-1">
                        <div className="min-w-0 flex-1">
                          <h3 className="font-medium text-[#262626] flex items-center gap-2 flex-wrap">
                            {review.author}
                              {review.verified && (
                              <span className="flex items-center text-[#030B19] text-xs whitespace-nowrap">
                  ...
                  {review.productTitle && review.productSlug && (
                    <div className="mb-2">
                      <span className="text-xs text-[#030B19] hover:text-[#0a0f32] hover:underline cursor-default inline-flex items-center gap-1">
                        {review.productTitle}
                      </span>
                    </div>
                  )}
                  ...
                  <div className="flex items-center justify-between mb-2">
                    <div className="flex">
                      {[...Array(5)].map((_, i) => (
                        <Star 
                          key={i}
                          className={`h-3.5 w-3.5 ${i < review.rating ? 'text-[#030B19] fill-[#030B19]' : 'text-gray-300'}`}
                        />
                      ))}
                    </div>
                  </div>
              ...
              <form onSubmit={handleSubmitReview} className="space-y-4">
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    <label className="flex items-center justify-center gap-2 px-4 py-3 border-2 border-dashed border-gray-300 rounded-lg cursor-pointer hover:border-[#030B19] hover:bg-[#030B19]/10 transition-colors duration-200">
                  ...
                  <button
                    ...
                    className={`flex-1 px-4 py-2 rounded-lg font-medium transition-colors duration-200 ${
                      isSubmitting 
                        ...
                        : 'bg-[#030B19] hover:bg-[#0a0f32] text-[#F0F6FF]'
                    }`}
                  >
