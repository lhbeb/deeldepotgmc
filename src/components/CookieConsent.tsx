...
const CookieConsent: React.FC = () => {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50" style={{ backgroundColor: '#030B19' }}>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center space-y-3 sm:space-y-0 sm:space-x-6">
          ...
          <div className="flex items-center space-x-3 sm:space-x-4">
            ...
            <button
              ...
              className="px-4 sm:px-6 py-2 bg-[#030B19] text-[#F0F6FF] border border-[#F0F6FF]/20 rounded-md hover:bg-[#0a0f32] transition-colors text-sm font-bold"
            >
              Accept All Cookies
            </button>
            <button
