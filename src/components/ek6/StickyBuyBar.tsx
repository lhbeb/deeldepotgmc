...
function getSiteHeaderBottomPx(): number {
  ...
  const nav = document.getElementById("site-header") ?? document.querySelector("header");
  if (!nav) return 49;
      ...
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
        <div className="flex min-w-0 flex-1 items-center gap-3">
          <div className="min-w-0">
            <h2 className="text-sm font-black leading-none text-black">CB VELO EK6 Folding Electric Bike</h2>
            <span className="mt-1 block text-sm font-bold text-[#d47b00]">$199.00</span>
          </div>
        </div>
