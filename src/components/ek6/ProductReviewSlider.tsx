    ...
    >
      <div className="relative h-[400px]">
        ...
        <button
          ...
          className="absolute inset-0 z-[5] cursor-pointer bg-transparent focus-visible:ring-2 focus-visible:ring-[#f5970c] focus-visible:ring-offset-2 focus-visible:outline-none"
            ...
            {slides.map((_, i) => (
              <button
                ...
                className={`pointer-events-auto h-1 rounded-full transition-all duration-300 ${
                  i === idx ? "w-8 bg-[#f5970c]" : "w-2 bg-white/30 hover:bg-white/50"
                }`}
