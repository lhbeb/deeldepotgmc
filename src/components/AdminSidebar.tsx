      ...
      >
        ...
        <div className="mx-4 my-4 p-4 bg-gradient-to-br from-gray-50 to-gray-100/50 rounded-2xl border border-gray-100">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 bg-gradient-to-br from-[#090A28] to-[#030B19] rounded-full flex items-center justify-center ring-2 ring-white shadow-lg">
              ...
              {getMainNavItems(ordersCount).map((item) => {
                ...
                return (
                  ...
                  >
                    ...
                    {item.badge !== undefined && item.badge > 0 && (
                      <span className={`text-xs px-2 py-0.5 rounded-full font-semibold min-w-[1.5rem] text-center ${active ? 'bg-[#030B19]/20 text-[#F0F6FF]' : 'bg-red-500 text-white'
                        }`}>
                        {item.badge}
                      </span>
                    )}
