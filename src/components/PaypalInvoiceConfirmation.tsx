                                        ...
                                        <div className="flex items-start gap-4">
                                            ...
                                            <div>
                                                ...
                                                <p className="mt-2 text-sm leading-7 text-emerald-900/85">
                                                    Thank you! Our Deel Depot payment team is verifying your PayPal transfer screenshot. <strong>Most orders are confirmed within 2–3 minutes.</strong> You will receive a confirmation email shortly.
                                                </p>
                    ...
                    <div className="w-1/2 flex-shrink-0 border-r border-gray-100 flex flex-col">
                        ...
                        <div className="p-8 flex flex-col flex-1">
                            ...
                            <p className="mt-3 text-center text-xs text-gray-400">
                                Questions?{' '}
                                <a href="mailto:contact@deeldepot.com" className="text-[#090A28] hover:underline">contact@deeldepot.com</a>
                            </p>
                        </div>
                    </div>
