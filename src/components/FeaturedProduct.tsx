  ...
  return (
    <div className="group flex h-full flex-col overflow-hidden rounded-2xl bg-white shadow-sm transition-all duration-300 hover:shadow-md md:flex-row">
      <div className="relative w-full overflow-hidden md:w-2/5 md:h-full">
        <div className="absolute left-4 top-4 z-10 rounded-full bg-[#030B19] px-3 py-1 text-sm font-medium text-[#F0F6FF] shadow-sm">
              ...
              {isSoldOut && (
                <div className="absolute inset-0 bg-[rgba(0,0,0,0.382)] flex items-center justify-center">
                  <div className="bg-[#f5970c] rounded-lg px-7 py-2.5">
                    <span className="sold-out-badge text-[#030B19] text-base md:text-lg uppercase tracking-wider whitespace-nowrap font-bold">
                      Sold Out
                    </span>
                  </div>
                </div>
      ...
      <div className="flex w-full flex-1 flex-col p-5 sm:p-6 md:w-3/5 md:h-full md:overflow-hidden md:justify-start">
        ...
        <div className="mt-4 md:mt-3 flex flex-col gap-2 sm:flex-row sm:gap-2">
          <Link
            href={`/products/${slug}`}
            className="flex-1 flex items-center justify-center rounded-lg bg-[#030B19] py-2 px-3 text-sm font-semibold text-[#F0F6FF] transition-colors duration-300 hover:bg-[#0a0f32] whitespace-nowrap"
          >
            Add to Cart
          </Link>
          <Link
            href={`/products/${slug}`}
            className="flex-1 flex items-center justify-center rounded-lg border border-[#030B19] py-2 px-3 text-sm font-semibold text-[#030B19] transition-colors duration-300 hover:bg-[#030B19]/10 whitespace-nowrap"
          >
