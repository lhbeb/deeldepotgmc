...
export default function AboutPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#F0F6FF]">
      ...
      {/* Hero Section */}
      <div className="bg-gradient-to-r from-[#030B19] to-[#030B19] text-[#F0F6FF] py-16">
      ...
      <div className="container mx-auto px-4 max-w-4xl py-12">
        {/* US Presence */}
        <section className="mb-12 border-y border-[#030B19]/15 py-9">
          <div className="grid gap-8 md:grid-cols-[220px_minmax(0,1fr)] md:items-start">
            <div>
              <div className="flex h-12 w-12 items-center justify-center rounded-lg bg-[#030B19] text-white">
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-[#030B19]/10 p-8 mb-12">
          <div className="mb-6">
          ...
          <div className="space-y-6">
            <div className="bg-[#F0F6FF] rounded-xl p-6 border border-[#030B19]/10 border-l-4 border-l-[#030B19]">
              <div className="flex items-start gap-4">
                <div className="flex-shrink-0 w-10 h-10 bg-[#030B19] text-[#F0F6FF] rounded-full flex items-center justify-center font-bold text-lg">
                  1
                </div>
                <div>
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-[#030B19]/10 p-8 mb-12">
          <div className="flex items-center gap-4 mb-6">
            <div className="p-3 bg-[#030B19]/10 rounded-xl">
              <Users className="h-8 w-8 text-[#030B19]" />
            </div>
        ...
        {/* Our Mission */}
        <div className="bg-gradient-to-r from-[#030B19] to-[#030B19] rounded-2xl shadow-lg p-10 mb-12 text-[#F0F6FF] text-center">
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-[#030B19]/10 p-8 mb-12">
          <div className="flex items-center gap-4 mb-8">
            <div className="p-3 bg-[#f5970c] rounded-xl">
              <Sparkles className="h-8 w-8 text-[#030B19]" />
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-[#F0F6FF] rounded-xl p-6 border border-[#030B19]/10">
              <div className="flex items-center gap-3 mb-3">
                <Package className="h-6 w-6 text-[#030B19]" />
            ...
            <div className="bg-[#F0F6FF] rounded-xl p-6 border border-[#030B19]/10">
              <div className="flex items-center gap-3 mb-3">
                <Eye className="h-6 w-6 text-[#030B19]" />
            ...
            <div className="bg-[#F0F6FF] rounded-xl p-6 border border-[#030B19]/10">
              <div className="flex items-center gap-3 mb-3">
                <DollarSign className="h-6 w-6 text-[#030B19]" />
            ...
            <div className="bg-[#F0F6FF] rounded-xl p-6 border border-[#030B19]/10">
              <div className="flex items-center gap-3 mb-3">
                <Headphones className="h-6 w-6 text-[#030B19]" />
            ...
            <div className="bg-[#F0F6FF] rounded-xl p-6 border border-[#030B19]/10 md:col-span-2">
              <div className="flex items-center gap-3 mb-3">
                <Leaf className="h-6 w-6 text-[#030B19]" />
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-[#030B19]/10 p-8 mb-12">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div className="bg-[#F0F6FF] rounded-xl p-6 text-center border border-[#030B19]/10">
              <div className="mx-auto mb-3 flex h-16 w-16 items-center justify-center rounded-full bg-[#f5970c]">
                <Zap className="h-8 w-8 text-[#030B19]" />
              </div>
        ...
        {/* Company Stats */}
        <div className="bg-gradient-to-r from-[#030B19] to-[#030B19] rounded-2xl shadow-lg p-10 mb-12 text-[#F0F6FF]">
        ...
        {/* Contact Information */}
        <div className="bg-white rounded-2xl shadow-lg border border-[#030B19]/10 p-8">
          <div className="flex items-center gap-4 mb-6">
            <div className="p-3 bg-[#030B19]/10 rounded-xl">
              <Phone className="h-8 w-8 text-[#030B19]" />
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="bg-[#F0F6FF] rounded-xl p-6 border border-[#030B19]/10">
              <div className="flex items-center gap-3 mb-3">
                <Phone className="h-5 w-5 text-[#030B19]" />
            ...
            <div className="bg-[#F0F6FF] rounded-xl p-6 border border-[#030B19]/10">
              ...
              <div className="text-gray-600 ml-8">contact@deeldepot.com</div>
            </div>
            <div className="bg-[#F0F6FF] rounded-xl p-6 border border-[#030B19]/10">
              <div className="flex items-center gap-3 mb-3">
                <Clock className="h-5 w-5 text-[#030B19]" />
