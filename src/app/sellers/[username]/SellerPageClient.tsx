...
export default function SellerPageClient({ seller }: Props) {
  ...
  return (
    <div className="min-h-screen bg-[#F0F6FF] flex flex-col font-sans">
      ...
      {/* Hero Section */}
      <div className="bg-gradient-to-br from-[#030B19] to-[#030B19] text-[#F0F6FF] pt-24 pb-12 rounded-b-[40px] shadow-lg relative overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto flex flex-col md:flex-row items-center md:items-start gap-8">
            ...
            <div className="w-32 h-32 md:w-40 md:h-40 rounded-full border-4 border-[#F0F6FF]/20 overflow-hidden flex-shrink-0 bg-[#F0F6FF]/5 relative z-20 shadow-2xl">
              {seller.avatarUrl ? (
                ...
                <div className="w-full h-full bg-gradient-to-br from-[#030B19] to-[#030B19] flex items-center justify-center text-5xl font-bold text-[#F0F6FF]">
            ...
            <div className="flex-1 text-center md:text-left">
              <div className="flex flex-col md:flex-row items-center md:items-end gap-3 mb-2">
                ...
                <div className="relative group flex">
                  <div className="cursor-help flex items-center gap-1.5 bg-[#f5970c] text-[#030B19] px-2.5 py-1 rounded-full text-xs font-semibold backdrop-blur-sm border border-[#f5970c]/50 transition-colors hover:bg-[#f5970c]/90">
                  ...
                  <div className="absolute top-full mt-3 left-0 md:left-auto md:right-auto w-72 p-4 bg-white text-gray-600 text-sm leading-relaxed rounded-2xl shadow-2xl border border-gray-100 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50 transform origin-top translate-y-2 group-hover:translate-y-0">
                    <div className="font-bold mb-1.5 flex items-center gap-1.5 text-[#262626]">
                      <Star className="w-4 h-4 text-[#030B19] fill-[#030B19]" /> Star Seller
                    </div>
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="flex flex-col lg:flex-row gap-8 items-start">
            ...
            <div className="w-full lg:w-1/3 xl:w-1/4 space-y-6 lg:sticky lg:top-24">
              <div className="bg-white p-6 rounded-3xl shadow-sm border border-[#030B19]/10">
                <h2 className="text-lg font-bold text-[#262626] mb-4 flex items-center gap-2">
                  <ShieldCheck className="w-5 h-5 text-[#030B19]" />
                  Seller Policies
                </h2>
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 leading-relaxed">100% genuine products. Backed by the Deel Depot Guarantee.</p>
                  </div>
                </div>
              </div>
              
              <div className="bg-gradient-to-br from-[#030B19] to-[#030B19] p-6 rounded-3xl border border-[#030B19]/10 flex flex-col items-center text-center text-[#F0F6FF] shadow-sm">
                ...
                <Link href="/contact" className="w-full px-4 py-2.5 bg-[#f5970c] text-[#030B19] font-medium rounded-xl hover:bg-[#f5970c]/90 transition-colors shadow-sm text-sm">
                  Contact Support
                </Link>
              </div>
            </div>
            ...
            <div className="w-full lg:w-2/3 xl:w-3/4 flex flex-col min-h-[50vh] gap-12">
              ...
              <div>
                ...
                {loading ? (
                    ...
                    {totalPages > 1 && (
                      <div className="mt-10 flex items-center justify-center gap-2">
                        <button
                          ...
                          className="flex items-center justify-center w-10 h-10 rounded-full border border-[#030B19]/15 bg-white text-gray-600 hover:bg-[#F0F6FF] hover:text-[#030B19] disabled:opacity-50 disabled:hover:bg-white disabled:hover:text-gray-600 transition-colors"
                            ...
                            <button
                              ...
                              className={`w-8 h-8 rounded-full text-sm font-medium transition-colors flex items-center justify-center ${
                                page === '...'
                                  ...
                                  : currentPage === page
                                  ? 'bg-[#030B19] text-[#F0F6FF]'
                                  : 'text-gray-600 hover:bg-[#F0F6FF] hover:text-[#030B19]'
                              }`}
                            >
                              {page}
                            </button>
                  ...
                  <div className="flex-1 bg-white rounded-3xl border border-[#030B19]/10 flex flex-col items-center justify-center p-12 text-center">
