...
const TYPE_COLORS: Record<string, string> = {
  client: 'bg-[#030B19]/10 text-[#030B19] border-[#030B19]/20',
              ...
              >
                ...
                <div className="flex items-center gap-1 flex-shrink-0" onClick={e => e.stopPropagation()}>
                  <button
                    ...
                    className={`p-1.5 rounded-lg transition-colors ${log.resolved ? 'hover:bg-[#030B19]/10 text-[#030B19]' : 'hover:bg-green-50 text-green-500'}`}
                  >
