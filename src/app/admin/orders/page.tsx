                  ...
                  <div className="mt-4 pt-4 border-t border-gray-100 flex flex-wrap gap-2">
                    ...
                    {!order.email_sent && (
                      <button
                        ...
                        className="inline-flex items-center gap-2 px-3 py-2 bg-[#030B19]/10 text-[#030B19] rounded-lg text-sm font-medium hover:bg-[#030B19]/15 disabled:opacity-50 transition-all"
                      >
