  ...
  return (
    <div className="relative w-full max-w-md">
      <div className="text-center mb-8">
        <div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-[#030B19] to-[#030B19] rounded-2xl shadow-2xl shadow-[#030B19]/30 mb-4">
      ...
      <div className="bg-white/10 backdrop-blur-xl rounded-3xl p-8 border border-white/10 shadow-2xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-5" autoComplete="on">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-3.5 bg-[#030B19] text-[#F0F6FF] font-bold rounded-xl hover:bg-[#0a0f32] focus:outline-none focus:ring-2 focus:ring-[#030B19] focus:ring-offset-2 focus:ring-offset-gray-900 disabled:opacity-50 disabled:cursor-not-allowed transition-all flex items-center justify-center gap-2 shadow-lg shadow-[#030B19]/25"
          >
            {loading ? (
    ...
    <Suspense
      fallback={
        <div className="relative w-full max-w-md bg-white/10 backdrop-blur-xl rounded-3xl p-8 border border-white/10 shadow-2xl flex items-center justify-center min-h-[400px]">
          <div className="w-10 h-10 border-4 border-[#030B19]/20 border-t-[#030B19] rounded-full animate-spin"></div>
        </div>
      }
    >
      <LoginFormInner />
