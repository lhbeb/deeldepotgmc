        ...
        <div className="mx-auto max-w-6xl overflow-hidden rounded-[28px] border border-[#D6E3FF] bg-white">
          <div className="grid lg:grid-cols-[minmax(0,1.1fr)_360px]">
            <section className="px-6 py-8 sm:px-8 sm:py-10 lg:px-10">
              <div className="mb-3 text-sm font-medium text-[#030B19]">
                Deel Depot order tracking
              </div>
              ...
              <p className="mt-4 max-w-2xl text-sm leading-7 text-[#5B6785] sm:text-base">
                Enter your tracking number below to see the latest carrier updates for your Deel Depot order.
              </p>
              ...
              <form onSubmit={handleTrack} className="mt-8 rounded-[24px] border border-[#E8EEF8] bg-[#F8FBFF] p-4 sm:p-5">
                ...
                <div className="flex flex-col gap-3 sm:flex-row">
                  <input
                    ...
                    maxLength={50}
                    autoComplete="off"
                    className="h-14 flex-1 rounded-2xl border border-[#D6E3FF] bg-white px-4 text-sm font-medium text-[#262626] outline-none transition focus:border-[#030B19]/35 focus:ring-2 focus:ring-[#030B19]/10"
                  />
                  <button
                    type="submit"
                    disabled={!isScriptReady || isSubmitting}
                    className="inline-flex h-14 items-center justify-center rounded-2xl bg-[#f5970c] px-6 text-sm font-semibold text-[#030B19] transition hover:bg-[#FFF7A0] disabled:cursor-not-allowed disabled:bg-[#D7DEF0] disabled:text-[#6E7AA1]"
                  >
            ...
            <aside className="border-t border-[#D6E3FF] bg-[#F8FBFF] px-6 py-8 lg:border-l lg:border-t-0">
              <div className="rounded-[24px] border border-[#DCE5F5] bg-white p-6">
                ...
                <div className="mt-4 space-y-4 text-sm leading-7 text-[#5B6785]">
                  <p>
                    Use the exact tracking number from your Deel Depot shipping confirmation email.
                  </p>
                  <p>
              ...
              <div className="mt-6 rounded-[24px] border border-[#DCE5F5] bg-white p-6">
                ...
                <a
                  href="mailto:contact@deeldepot.com"
                  className="mt-5 inline-flex items-center justify-center rounded-2xl border border-[#030B19]/15 bg-[#f5970c] px-5 py-3 text-sm font-semibold text-[#030B19] transition hover:bg-[#FFF7A0]"
                >
                  Contact Support
                </a>
              </div>
