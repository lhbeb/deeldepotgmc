    ...
    <div className="min-h-screen bg-[#F0F6FF] py-10 sm:py-14">
      <div className="container mx-auto px-4">
        <div className="overflow-hidden rounded-[32px] border border-[#D6E3FF] bg-white shadow-[0_24px_80px_rgba(0,48,153,0.10)]">
          <section className="bg-gradient-to-br from-[#030B19] via-[#030B19] to-[#030B19] px-6 py-10 text-[#F0F6FF] sm:px-10 sm:py-12">
                    ...
                    return (
                      <div key={step.title} className="rounded-[20px] border border-[#E8EEF8] bg-[#F8FBFF] p-5">
                        <div className="flex items-start gap-4">
                          <div className="flex h-11 w-11 flex-shrink-0 items-center justify-center rounded-2xl bg-[#EEF4FF] text-[#030B19]">
              ...
              <section className="rounded-[24px] border border-[#DCE5F5] bg-white p-6 sm:p-7">
                ...
                <div className="mt-5 flex flex-col gap-3 sm:flex-row">
                  <a
                    ...
                    className="inline-flex items-center justify-center rounded-2xl bg-[#030B19] px-5 py-3 text-sm font-semibold text-[#F0F6FF] transition hover:bg-[#0a0f32]"
                  >
                    Email Support
                  </a>
                  <Link
                    href="/contact"
                    className="inline-flex items-center justify-center rounded-2xl border border-[#030B19]/20 bg-white px-5 py-3 text-sm font-semibold text-[#030B19] transition hover:bg-[#EEF4FF]"
                  >
                    Contact Page
                  </Link>
                </div>
