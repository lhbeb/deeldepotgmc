    ...
    <main className="min-h-screen bg-[#F5F7FB] py-12 sm:py-16">
      ...
      <div className="container mx-auto max-w-5xl px-4">
        ...
        <section className="mb-8 grid gap-4 md:grid-cols-3">
          ...
          <div className="rounded-xl border border-[#030B19]/10 bg-white p-5 shadow-sm">
            <ShieldCheck className="mb-4 h-6 w-6 text-[#030B19]" />
        ...
        <section className="mb-8 rounded-2xl border border-[#030B19]/10 bg-white p-6 shadow-sm sm:p-8">
              ...
              <ul className="mt-4 space-y-3 text-sm leading-6 text-gray-600">
                {section.items.map((item) => (
                  <li key={item} className="flex gap-3">
                    <span className="mt-2 h-1.5 w-1.5 flex-shrink-0 rounded-full bg-[#030B19]" />
                    <span>{item}</span>
                  </li>
                ))}
              </ul>
        ...
        <section className="mt-8 rounded-2xl border border-[#030B19]/10 bg-white p-6 shadow-sm sm:p-8">
          ...
          <div className="mt-6 grid gap-4 sm:grid-cols-3">
            ...
            <div className="flex items-center gap-3 rounded-xl bg-[#F5F7FB] p-4">
              ...
              <span className="text-sm font-medium text-[#262626]">contact@deeldepot.com</span>
            </div>
            <div className="flex items-center gap-3 rounded-xl bg-[#F5F7FB] p-4">
          ...
          <Link
            href="/contact"
            className="mt-6 inline-flex items-center justify-center rounded-xl bg-[#030B19] px-5 py-3 text-sm font-semibold text-[#F0F6FF] transition hover:bg-[#0a0f32]"
          >
            Contact Support
          </Link>
        </section>
