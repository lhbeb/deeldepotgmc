  ...
  return (
    <div
      className={cn(
        ...
        enabled ? "border-blue-600 bg-blue-600/5" : "border-zinc-200 bg-zinc-50/80",
      )}
    >
      <div className="flex min-w-0 items-center gap-4">
        <div
          className={cn(
            ...
            enabled ? "border-blue-100 bg-blue-50" : "border-zinc-200 bg-white",
          )}
        >
          <IconShieldCheck className={cn("h-6 w-6", enabled ? "text-blue-600" : "text-zinc-400")} />
        </div>
        <div className="min-w-0 space-y-0.5">
          <h4 className={cn("text-[15px] font-bold", enabled ? "text-blue-600" : "text-zinc-900")}>{title}</h4>
