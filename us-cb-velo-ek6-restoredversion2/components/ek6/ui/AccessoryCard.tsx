      ...
      <div
        className={cn(
          ...
          checked
            ...
            : "border-zinc-200 bg-white group-hover:border-blue-400",
        )}
      >
        {checked ? (
  ...
  return (
    <button
      ...
      className={cn(
        ...
        selected
          ? accent === "amber"
            ? "border-amber-200 bg-amber-50/50 ring-1 ring-amber-200"
    ...
    >
      ...
      <div className="flex min-w-0 flex-1 flex-col justify-center">
        <div className="flex items-center gap-1.5">
          ...
          {isFreeGift ? (
            <span className="flex items-center gap-1 rounded px-1.5 py-0.5 text-[10px] font-black uppercase tracking-wider text-amber-600 animate-pulse bg-amber-100">
              <GiftIcon />
              Free Gift
            </span>
          ) : (
        ...
        <div className="flex items-center gap-1 lg:mt-0.5">
          ...
          {isFreeGift ? (
            <span className="text-sm font-black uppercase tracking-tight text-amber-600">FREE</span>
          ) : (
            <span className="text-sm font-black text-blue-600">{priceDisplay}</span>
          )}
        </div>
      </div>
    </button>
