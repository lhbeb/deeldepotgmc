                ...
                return (
                  <section key={bikeIdx} className="space-y-3" aria-labelledby={headingId}>
                    ...
                    >
                      {bikeCount === 1 ? (
                        <>
                          Bike Color - <span className="font-extrabold text-blue-600">{colorLabel}</span>
                        </>
                      ) : (
                        <>
                          Bike {bikeIdx + 1} Color -{" "}
                          <span className="font-extrabold text-blue-600">{colorLabel}</span>
                        </>
                      )}
                    </h3>
                    <div
                          ...
                          <div className="relative h-10 w-10">
                            <div
                              className={`absolute -inset-1.5 rounded-full border-[2.5px] transition-all duration-300 ${
                                selected === id
                                  ? "border-blue-600 opacity-100 shadow-lg shadow-blue-600/20"
